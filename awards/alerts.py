...
Nominee Details:
- Name:        {employee.name}
- Monetary:    ${employee.monetary:.2f} ({monetary_ratio:.2%} of ${max_monetary:.2f} limit)
- Time-Off:    {employee.hours} hours ({hours_ratio:.2%} of {max_hours}-hour limit)
- Total:       {monetary_ratio + hours_ratio:.2%} (Max Allowed: 100%)
